...
export default function PublicationsPage() {
  ...
  const loadData = async () => {
    setLoading(true); // Loading aktif saat mencari
    try {
      // Page 1, Limit 100 (agar admin bisa lihat banyak data), Search Query
      const res = await publicationService.getAll(1, 100, debouncedSearch);
  ...
  // HAPUS filteredData (Kita pakai 'publications' langsung)
